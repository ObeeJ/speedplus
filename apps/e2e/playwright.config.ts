  ...
  webServer: [
    {
      ...
      command: 'go run github.com/fourdat/api/cmd/server',
      ...
      env: {
        ...
        DATABASE_URL: process.env['DATABASE_URL'] ?? 'postgres://fourdat:fourdat@localhost:5433/fourdat?sslmode=disable',
    ...
    {
      command: 'pnpm --filter @fourdat/customer dev',
    ...
    {
      command: 'pnpm --filter @fourdat/driver exec next dev --turbopack --port 3001',
    ...
    {
      command: 'pnpm --filter @fourdat/merchant dev',
    ...
    {
      command: 'pnpm --filter @fourdat/admin dev',
