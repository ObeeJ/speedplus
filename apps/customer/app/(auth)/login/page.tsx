  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[560px] flex-shrink-0 bg-[#0A3D2C] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="flex flex-col gap-6 relative z-10">
          <h2 className="font-display font-bold text-[42px] leading-[1.1] text-white">
            Faster.<br />Cheaper.<br />
            <span className="text-[#C6F24E]">Better.</span>
          </h2>
          <p className="text-white/60 text-lg leading-relaxed max-w-xs">
            Essential delivery for everyday Nigeria. Gas, groceries, food, pharmacy, packages.
          </p>
        </div>

        <p className="text-white/30 text-xs relative z-10">
          &copy; {new Date().getFullYear()} SpeedPlus Technologies
        </p>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-[#F7F5EF] px-5 py-12 lg:px-16">
        ...
        >
          <div>
            <h1 className="font-display font-bold text-[28px] text-[#121216] tracking-tight">Welcome back</h1>
            <p className="text-[#63636E] mt-1">Sign in to continue</p>
          </div>
          ...
          <p className="text-center text-sm text-[#63636E]">
            ...
            <Link href="/register" className="font-semibold text-[#0A3D2C] hover:underline">
              Create one
            </Link>
          </p>
        </div>
