...
export default function PharmacyFindingPage() {
  const router = useRouter();

  useEffect(() => {
    const timer = setTimeout(() => router.push('/pharmacy/tracking'), 2200);
  ...
  return (
    <main className="min-h-screen bg-emerald flex flex-col items-center justify-center gap-5 px-5">
      ...
      <span className="font-display font-semibold text-xl text-sand text-center">Packing and sealing your order…</span>
