...
const STEPS = ['Order confirmed', 'Kitchen cooked it fresh', 'On the way', 'Delivered'];
...
export default function FoodTrackingPage() {
  const { deliverTo, orderId, reset } = useFoodFlowStore();
    ...
    <main className="min-h-screen bg-sand flex flex-col">
      ...
      <div className="flex-1 px-5 py-6 min-[700px]:max-w-[860px] min-[700px]:mx-auto min-[700px]:px-8 min-[700px]:py-10 min-[700px]:w-full flex flex-col gap-6">
        <div className="bg-white border border-line rounded-2xl p-4 flex items-center gap-3">
          <span className="w-11 h-11 rounded-full bg-tile flex items-center justify-center font-display font-semibold text-emerald">T</span>
          <div className="flex-1 flex flex-col">
            <span className="font-semibold text-ink text-[14px]">Tunde</span>
            <span className="text-[12px] text-mid">Bike · ★ 4.7</span>
          </div>
